...
* Fixed Unity 5 support (from Unity 5.2.0f3 onward).
* Reverb: Fix Brightness parameter to be normalized (which is what the underlying code expects; prior to this fix it was clamping to [0,1])
* Reverb: additional tooltips for clarity
